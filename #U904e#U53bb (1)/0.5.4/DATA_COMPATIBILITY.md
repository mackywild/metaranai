# Data compatibility contract: V0.4 / V0.5 / V0.5.1 / V0.5.2 / V0.5.3 → V0.5.4

V0.5.4 is an additive update. Existing analysis data remains the compatibility contract.

| Item | Existing data | V0.5.4 behavior |
|---|---|---|
...
| `search_history` | existing history | preserved; V0.5.4 does not truncate new saves |
...
V0.5.4 never infers the two new extreme ratings from old data. A legacy HIT is **not** promoted to `全部好き`, and a legacy MISS is **not** demoted to `興味なし`.
