...
for marker in ['PERSONAL METAL ARCHIVE','未評価','GenreLensCatalog.names()','VocalType.FEMALE','Spotify直行リンク取得済み']:
...
assert 'out.put("version", 60)' in store
assert 'Metaranai-Android/0.6.0' in ext
assert 'metaranai-v0.6.0-apk' in workflow
