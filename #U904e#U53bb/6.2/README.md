...
V0.6.2 improves direct Spotify navigation without restoring partial-name guesses. Exact-name matches can now be confirmed using Local Metal DB metadata + MusicBrainz.

自分のMETAL DNAを学習し、地下まで掘って「今日の1組」を推薦しながら、聴くほどPersonal Metal Archiveを育てるAndroidアプリ。

## V0.6.2 — SPOTIFY IDENTITY RESOLVER 2
...
- 新しい本人確認済みcache `spotify_artist_links_v062` を使用
