...
object MetalCatalog {
    val artists = listOf(
        MetalArtist("SKYWINGS", "Japan", listOf("Melodic Power Metal", "Symphonic"), MetalVector(.98f,.86f,.55f,.88f,.62f,.04f,.98f,.96f), .82f, "高密度のクサメロと疾走感", vocalType = VocalType.MALE),
        MetalArtist("MinstreliX", "Japan", listOf("Melodic Power Metal"), MetalVector(.96f,.90f,.58f,.75f,.64f,.08f,.96f,.91f), .86f, "国産メロスピの美旋律をさらに掘る", vocalType = VocalType.MALE),
        ...
        MetalArtist("Versailles", "Japan", listOf("Symphonic Power Metal"), MetalVector(.91f,.78f,.62f,.94f,.72f,.08f,.93f,.88f), .58f, "華麗さと劇的メロディを重視", vocalType = VocalType.MALE),
        MetalArtist("Lovebites", "Japan", listOf("Power Metal", "Heavy Metal"), MetalVector(.84f,.88f,.72f,.54f,.78f,.04f,.97f,.82f), .45f, "クリーンVoと高速ツインギター", vocalType = VocalType.FEMALE),
        MetalArtist("Twilight Force", "Sweden", listOf("Symphonic Power Metal"), MetalVector(.94f,.90f,.52f,.96f,.64f,.01f,.99f,.94f), .48f, "明るいクサメロと大仰なシンフォニー", vocalType = VocalType.MALE),
        MetalArtist("Fellowship", "United Kingdom", listOf("Power Metal"), MetalVector(.96f,.82f,.48f,.72f,.58f,.00f,.99f,.98f), .67f, "多幸感のあるメロディとキャッチーさ", vocalType = VocalType.MALE),
        MetalArtist("Majestica", "Sweden", listOf("Power Metal"), MetalVector(.93f,.88f,.53f,.68f,.67f,.01f,.99f,.95f), .62f, "明快なサビと疾走パワーメタル", vocalType = VocalType.MALE),
        MetalArtist("Dynazty", "Sweden", listOf("Melodic Metal"), MetalVector(.88f,.68f,.66f,.45f,.60f,.02f,.99f,.96f), .50f, "モダンさを保ちつつサビが強い"),
        MetalArtist("Keldian", "Norway", listOf("Power Metal", "Melodic Metal"), MetalVector(.92f,.75f,.54f,.58f,.62f,.02f,.97f,.91f), .89f, "知名度控えめでメロディ偏重", vocalType = VocalType.MALE),
        ...
        MetalArtist("Temperance", "Italy", listOf("Melodic Metal", "Symphonic"), MetalVector(.89f,.71f,.58f,.84f,.61f,.05f,.98f,.94f), .70f, "男女クリーンVoとキャッチーな旋律", vocalType = VocalType.MIXED),
        MetalArtist("Frozen Crown", "Italy", listOf("Power Metal"), MetalVector(.86f,.89f,.69f,.54f,.75f,.17f,.88f,.85f), .66f, "疾走とヘヴィさのバランス"),
        MetalArtist("Seven Spires", "USA", listOf("Symphonic Metal"), MetalVector(.86f,.69f,.78f,.92f,.79f,.48f,.72f,.78f), .77f, "少し冒険したい日に刺さる劇的サウンド", vocalType = VocalType.FEMALE),
        ...
        MetalArtist("Amberian Dawn", "Finland", listOf("Symphonic Metal"), MetalVector(.88f,.68f,.56f,.92f,.62f,.06f,.99f,.89f), .69f, "女性クリーンVoとキーボード主体の旋律", vocalType = VocalType.FEMALE),
        MetalArtist("Astralion", "Finland", listOf("Power Metal"), MetalVector(.92f,.89f,.57f,.61f,.66f,.02f,.98f,.91f), .88f, "北欧らしい疾走と透明感の強いサビ"),
        MetalArtist("Arion", "Finland", listOf("Symphonic Metal", "Melodic Metal"), MetalVector(.88f,.66f,.64f,.86f,.67f,.06f,.96f,.93f), .72f, "モダン寄りでも旋律とクリーンVoが強い", vocalType = VocalType.FEMALE),
